...
{
    /* ALL THIS PARSING STUFF SEEMS LIKE IT IS NEEDED */
    ...
    /* Creating transport socket or smtn */
    switch (trans)
    {
    case TRANS_TCP:
    ...
    /* DEFINING CALLBACK FUNCTION FOR WHEN THE CLIENTS FINISH RUNNING */
    ...
    /* MORE ADDITIONAL CONFIGURATION PARSING */
